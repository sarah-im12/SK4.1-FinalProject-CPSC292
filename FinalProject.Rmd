...
### Properly Formatted Data was plotted using ggplot to represent the Democratic Approval Rates
...
### Properly Formatted Data was plotted using ggplot to represent the Republican Party Approval Rates
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggsave(filename = "results/figures/vis1.pdf", plot = vis1, device = "pdf", 
       width = 6, height = 5, units = "in")

ggsave(filename = "results/figures/vis2.pdf", plot = vis2, device = "pdf", 
       width = 6, height = 5, units = "in")
